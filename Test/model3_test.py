...
if __name__ == '__main__':
    ...
    test_images_path = base_dir.parent / 'Data' / 'training_data' / 'test' / 'img'
    test_labels_path = base_dir.parent / 'Data' / 'training_data' / 'test' / 'lbl'
    ...
    test_transforms = Compose([
        ...
        Resized(keys=["img", "seg"], spatial_size=(1024, 1024)),  # Ensure both have the same size
        ToTensor()
    ])
